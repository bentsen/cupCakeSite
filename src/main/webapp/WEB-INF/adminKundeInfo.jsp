...
<%@ page import="business.persistence.DBConnector" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="business.entities.Kunde" %>
...
<div class="container-fluid">
    <div class="jumbotron">
        <h2 style="text-align: center;">Oversigt over alle kunder</h2>
       <div class="row">
        ...
        <c:forEach var="kunde" items="${sessionScope.kundeList}">
            <div class="row">
                ...
                <div class="col">${kunde.password}</div>
                <div class="col">${kunde.address}</div>
                <div class="col">${kunde.postNr}</div>
            </div>
        </c:forEach>
        <br>
    </div>
